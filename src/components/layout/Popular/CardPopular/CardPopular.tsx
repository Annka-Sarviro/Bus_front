...
const CardPopular = (props: IProps) => {
    ...
    const setSelectRoutsTo = usePopular(state => state.setSelectRoutsTo);
    const setSelectRoutsFrom = usePopular(state => state.setSelectRoutsFrom);
    ...
    return (
        <Box>
            <Card component={'div'} onClick={PopularPush} className={Style.hover} elevation={0}>
