...
import { BsBoxFill, BsFillGeoAltFill, BsTicketPerforatedFill } from 'react-icons/bs';
...
import { dashBoardStaticData, headerStaticDataProp } from '@/interface/IStaticData';
