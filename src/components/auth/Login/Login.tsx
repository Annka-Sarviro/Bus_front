...
export function Login({ staticData, lang }: { staticData: loginStaticDataProp; lang: Locale }) {
                ...
                <Container maxWidth="xs" disableGutters>
                    ...
                    >
                        ...
                        <Box component="form" noValidate sx={{ mt: 1 }}>
                            <Typography
                                sx={{ color: theme.customColors.primary_cover, fontSize: 16 }}
                                my={2}
                            ...
                            <Box className={Style.login__registration}>
