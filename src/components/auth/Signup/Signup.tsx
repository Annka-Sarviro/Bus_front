...
export default function Signup({
    ...
    const signup = async (event: any) => {
        event.preventDefault();
        try {
            const res = await axios.post(`${process.env.NEXT_PUBLIC_BACK_URL}auth/users/`, {
                headers: {
            ...
            <Container maxWidth="xs" disableGutters>
                ...
                >
                    ...
                    <Box component="form" noValidate sx={{ mt: 1 }}>
                        <Typography sx={{ fontSize: 16 }} my={2} className={Style.signup__text}>
                        ...
                        <Box className={Style.signup__login}>
